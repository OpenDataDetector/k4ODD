...
for calodigicol, ecalorhcal, inputcol, outputcol, relcol in zip(
    ...
    calodigicol.CalibrECAL = [1,1] #37.5227197175, 37.5227197175]
    calodigicol.ECALEndcapCorrectionFactor = 1 #1.03245503522
    calodigicol.ECALBarrelTimeWindowMax = 20.0 #10
    calodigicol.ECALEndcapTimeWindowMax = 20.0 #10
    calodigicol.CalibrHCALBarrel = [1] #45.9956826061]
    calodigicol.CalibrHCALEndcap = [1] #46.9252540291]
    calodigicol.CalibrHCALOther = [1] #57.4588011802]
    calodigicol.HCALBarrelTimeWindowMax = 20.0 # 10
    calodigicol.HCALEndcapTimeWindowMax = 20.0 # 10
...
MyTruthTrackFinder.Parameters = {
                                 ...
                                 "SiTrackCollectionName": ["TrackCollection"],
                                 "SiTrackRelationCollectionName": ["TrackRelationsCollection"],
                                 "SimTrackerHitRelCollectionNames": [],
                                 "TrackerHitCollectionNames": ["PixelBarrelReadout", "PixelEndcapReadout", "ShortStripBarrelReadout", "ShortStripEndcapReadout", "LongStripBarrelReadout", "LongStripEndcapReadout"],
...
pandora.Parameters = {
    "PandoraSettingsXmlFile": ["PandoraSettingsMinimal.xml"],
    "ECalMipThreshold": ["0.5"],
    "HCalMipThreshold": ["0.25"],
    ...
    "MuonToMipCalibration": ["50"],
    "ECalToEMGeVCalibration": ["1.0"],
    "HCalToEMGeVCalibration": ["1.0"],
    "UseDD4hepField": ["1"],
    "MCParticleCollections": ["MCParticle"],
    "ECalCaloHitCollections": ["ECalBarrelDigi"],
    "HCalCaloHitCollections": ["HcalBarrelDigi"],
    "MuonCaloHitCollections": ["MUON"],
    "RelCaloHitCollections": ["digiRelationCaloHit"],
    "TrackCollections": ["TrackCollection"],
    "RelTrackCollections": ["TrackRelationsCollection"],
    "TrackSystemName" : [""],  # disable marlin track fitting
}

ApplicationMgr(
    TopAlg=calodigi + [merger] ,#+ [MyTruthTrackFinder,pandora],
    EvtSel="NONE",
    EvtMax=100,
