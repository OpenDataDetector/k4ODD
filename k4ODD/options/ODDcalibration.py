...
from Configurables import Lcio2EDM4hepTool, MarlinProcessorWrapper
...
sequenceLoader.load("LCPandoraAnalysis/")
...
# We need to convert the outputs in case we have LCIO output
attach_lcio2edm4hep_conversion(algList)


ApplicationMgr(
    TopAlg=calodigi + [merger] + algList,
    EvtSel="NONE",
    EvtMax=100,
